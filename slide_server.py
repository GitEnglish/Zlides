                                    ...
                                    if item_type == "object":
                                        ...
                                        if isinstance(obj, dict):
                                            ...
                                            if (
                                                ...
                                                and len(output)
                                                > 10  # Lower threshold - small chunks like closing tags matter
                                            ):
                                                # This is slide HTML from a tool call
                                                ...
                                                print(
                                                    f"[Stream] Got tool output: {tool_name}, {len(output)} chars, position={position}"
                                                )

                                                # Forward to frontend as a slide_page event
